...
if st.button("Show simulation", key="show_button_1"):
...
- Was the time until peak concentration what you expected? Was it longer/shorter than you expected?
""")
...
- How much do you need to delay the last drink to have the peak blood alcohol concentration to not increase over the next-to-last drink?
""")
